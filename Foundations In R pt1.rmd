...
```{r}
shows<- c("New Girl", "Broad City", "Bobs Burgers", "Dexter")
rating<- c(10, 10, 10, 8)
```
...
```{r}
showData<- cbind.data.frame(shows, rating)
showData
```
...
## Practice
1. create a subset of data from mycars that contains all cars with less than 25 mpg.
```{r}
lessthan225mpg<- subset(mtcars, mtcars$mpg< 25)
```
...
```{r}
sd(mtcars$mpg) #typical distance from the mean
```
...
```{r}
range(ChickWeight$weight[ChickWeight==1])
range(ChickWeight$weight[ChickWeight==2])
range(ChickWeight$weight[ChickWeight==3])
range(ChickWeight$weight[ChickWeight==4])
range(ChickWeight$weight[ChickWeight==5])
range(ChickWeight$weight[ChickWeight==6])
range(ChickWeight$weight[ChickWeight==7])
range(ChickWeight$weight[ChickWeight==8])
#for next time!
```